...
type GoliteParserListener interface {
	...
	// EnterOpRelationTerm is called when entering the opRelationTerm production.
	EnterOpRelationTerm(c *OpRelationTermContext)

	// EnterRelationTerm is called when entering the relationTerm production.
	EnterRelationTerm(c *RelationTermContext)

	// EnterOpSimpleTerm is called when entering the opSimpleTerm production.
	EnterOpSimpleTerm(c *OpSimpleTermContext)

	// EnterSimpleTerm is called when entering the simpleTerm production.
	EnterSimpleTerm(c *SimpleTermContext)

	// EnterOpTerm is called when entering the opTerm production.
	EnterOpTerm(c *OpTermContext)

	// EnterTerm is called when entering the term production.
	EnterTerm(c *TermContext)

	// EnterOpUnaryTerm is called when entering the opUnaryTerm production.
	EnterOpUnaryTerm(c *OpUnaryTermContext)
	...
	// ExitOpRelationTerm is called when exiting the opRelationTerm production.
	ExitOpRelationTerm(c *OpRelationTermContext)

	// ExitRelationTerm is called when exiting the relationTerm production.
	ExitRelationTerm(c *RelationTermContext)

	// ExitOpSimpleTerm is called when exiting the opSimpleTerm production.
	ExitOpSimpleTerm(c *OpSimpleTermContext)

	// ExitSimpleTerm is called when exiting the simpleTerm production.
	ExitSimpleTerm(c *SimpleTermContext)

	// ExitOpTerm is called when exiting the opTerm production.
	ExitOpTerm(c *OpTermContext)

	// ExitTerm is called when exiting the term production.
	ExitTerm(c *TermContext)

	// ExitOpUnaryTerm is called when exiting the opUnaryTerm production.
	ExitOpUnaryTerm(c *OpUnaryTermContext)
